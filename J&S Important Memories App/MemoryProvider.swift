...
struct MemoriesProvider {
    let memories: [Memory] = [
        ...
        Memory(month: 8, day: 9, year: 2013, description: "Our first trip together as a couple", whatIRemember: "Going to Jacksonville was kind of like bringing the girl home to meet the parents. I always highly valued the opinion of my close friends so a part of me was nervous. Why, I don't know because they loved you!"),
        Memory(month: 11, day: 14, year: 2013, description: "Aproximate time around when we shared our stories and past", whatIRemember: "This memory can be summed up with one word: intimacy. I just remember thinking, \"Finally! someone to share anything with!\""),
        Memory(month: 1, day: 1, year: 2014, description: "The day I really started begging God for you", whatIRemember: "What makes this day so unique is the fact that it dawned on me for the first time that nothing is set in stone and since I haven't married you yet, you might still walk away from this. It scared me so much that I started praying a lot about our future"),
        Memory(month: 1, day: 21, year: 2014, description: "Started financially planning for a ring", whatIRemember: "One of the more cherished memories as I just remember praying to God saying I need a miracle and help to get that ring!"),
        ...
        Memory(month: 2, day: 14, year: 2015, description: "The day we confirmed we were pregnant", whatIRemember: "Sitting in that Doctor's office as he walked in and told us the good news was amazing feeling. Most people do a romantic dinner for Valentine's day. I got one better. I found out my family was about to get a little bigger together with the love of my life!"),
